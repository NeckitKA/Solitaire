...
Card::Card(const Card& other) {
	...
	SetParentStack(other.GetParentStack(), false);
	SetValue(other.value);
	SetCardOpen(other.cardOpen);
	card->Parent = GetParentForm();
	...
	cardNumInStack = other.cardNumInStack;
	startX = other.startX;
	startY = other.startY;
	top = other.top;
	newParentStackNum = other.newParentStackNum;
	cardDragging = false;
	cardInStackArea = false;
